...
NAMED_ENTITIES = {
    ...
    "PS_PET": ("ne.companion-animal*", AMRNamedEntityConcept),
    ...
    "CV_NAME": "ethnic-group",   # ex. 인더스문명, 황허문명, 거석문화, 도싯문화, 4차산업혁명, 르네상스
    "CV_TRIBE": "ethnic-group",   # ex. 이라크족, 유대인, 조선족, 마오리족, 아메리카인디언
    "CV_LANGUAGE": "language",   # ex. 한국어, 아랍어, 프랑스어, 산스크리트
    "CV_POLICY": "policy*",   # ex. 카스트, 쓰레기종량제, 직업공무원제도, 연금제도, 고시제도
    "CV_LAW": "law",   # ex. 국제연합헌장, 민법, 형법, 함무라비법전, 관습법, 헌법
